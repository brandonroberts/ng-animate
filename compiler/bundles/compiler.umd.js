...
(function (global, factory) {
    ...
    */
    ...
    function _parseAnimationKeyframes(keyframeSequence, currentTime, collectedStyles, stateStyles, errors) {
        ...
        if (doSortKeyframes) {
            ListWrapper.sort(keyframes, function (a, b) { return a.offset <= b.offset ? -1 : 1; });
        }
        return keyframes;
    }
    ...
    var _ANIMATION_VOID_STATE_VALUE = literal('void');
    var _ANIMATION_STYLE_UTIL = importExpr(Identifiers.AnimationStyleUtil);
    ...
    var _AnimationBuilder = (function () {
        ...
        _AnimationBuilder.prototype.visitAnimationStep = function (ast, context) {
            ...
            context.styleState = _AnimationStyleStepState.NormalStyles;
            var keyframesExpr = literalArr(keyframes);
        ...
        _AnimationBuilder.prototype.visitAnimationStateTransition = function (ast, context) {
            ...
            var precondition = _ANIMATION_PLAYER_VAR.equals(NULL_EXPR);
        ...
        _AnimationBuilder.prototype.visitAnimationEntry = function (ast, context) {
            ...
            statements.push(_ANIMATION_STYLES_LOOKUP.set(literalMap(lookupMap)).toDeclStmt());
            ...
            statements.push(
            // void => ...
            new IfStmt(_ANIMATION_CURRENT_STATE_VAR.equals(importExpr(Identifiers.uninitialized)), [
                _ANIMATION_CURRENT_STATE_VAR.set(_ANIMATION_VOID_STATE_VALUE).toStmt()
            ]), 
            // ... => void
            new IfStmt(_ANIMATION_NEXT_STATE_VAR.equals(importExpr(Identifiers.uninitialized)), [
    ...
    function _compareToAnimationStateExpr(value, animationState) {
        var compareValue = animationState == EMPTY_STATE ? _ANIMATION_VOID_STATE_VALUE : literal(animationState);
            ...
            switch (boundProp.type) {
                ...
                case exports.PropertyBindingType.Animation:
                    ...
                    view.detachMethod.addStmt(PLAYER_VAR.set(animation.fnVariable.callFn([
                        ...
                        renderNode,
                        oldRenderValue,
                        importExpr(Identifiers.uninitialized)
                    ])).toDeclStmt());
                    break;
            }
