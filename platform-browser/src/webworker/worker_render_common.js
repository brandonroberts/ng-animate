...
exports.WORKER_RENDER_PLATFORM_PROVIDERS = [
    core_2.PLATFORM_COMMON_PROVIDERS,
    /*@ts2dart_const*/ ({ provide: exports.WORKER_RENDER_PLATFORM_MARKER, useValue: true }),
    /* @ts2dart_Provider */ { provide: core_2.PLATFORM_INITIALIZER, useValue: initWebWorkerRenderPlatform, multi: true }
];
exports.WORKER_RENDER_APPLICATION_COMMON_PROVIDERS = 
/*@ts2dart_const*/ [
    core_2.APPLICATION_COMMON_PROVIDERS,
    ...
    /* @ts2dart_Provider */ { provide: core_2.ExceptionHandler, useFactory: _exceptionHandler, deps: [] },
    ...
    /* @ts2dart_Provider */ { provide: hammer_gestures_2.HAMMER_GESTURE_CONFIG, useClass: hammer_gestures_2.HammerGestureConfig },
    /* @ts2dart_Provider */ { provide: dom_renderer_1.DomRootRenderer, useClass: dom_renderer_1.DomRootRenderer_ },
    /* @ts2dart_Provider */ { provide: core_2.RootRenderer, useExisting: dom_renderer_1.DomRootRenderer },
...
function _exceptionHandler() {
    return new core_2.ExceptionHandler(dom_adapter_1.getDOM(), !lang_1.IS_DART);
}
function _document() {
